...
const GOOGLE_SHEET_CSV_URL =
  "https://docs.google.com/spreadsheets/d/1a88IFlffi03PAiuDaL0hrWpwfMXlGbV7Xvatz6IyhGU/export?format=csv";

const STYLES = ["Vinyasa", "Yin", "Stretch", "Senior", "Advanced"];
...
export default function YogaPage() {
  ...
  useEffect(() => {
    ...
    Papa.parse(GOOGLE_SHEET_CSV_URL, {
      ...
      header: true,
      complete: (results) => {
        setVideos(results.data as YogaVideo[]);
        setLoading(false);
      },
  ...
  const filteredVideos = videos.filter((video) => {
    const matchesSearch =
      ...
      video.style.toLowerCase().includes(search.toLowerCase());
    const matchesFilter =
      !filter ||
      (filter === "Advanced"
          ...
          {STYLES.map((style) => (
            <button
              ...
              style={{
                ...
                borderRadius: 24,
                border:
                  filter === style ? "2px solid #6f62f7" : "1px solid #ccc",
                background: filter === style ? "#edeaff" : "#f8f8f8",
                color: "#444",
                fontWeight: filter === style ? "bold" : "normal",
                cursor: "pointer",
                fontSize: 15.5,
                boxShadow: filter === style ? "0 2px 8px #6f62f71a" : undefined,
          ...
          >
            ...
            {expandedId === video.id ? (
              ...
              >
                ...
                />
                {/* Optionally, overlay duration or style */}
                <div
                  style={{
                    position: "absolute",
                    bottom: 0,
